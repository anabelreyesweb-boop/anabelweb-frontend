        ...
        <div className="home-custom__courses">
          <div className="page-container">
            ...
            <p className="home-custom__courses-text">
              Access all the courses you need to improve your project on a
              single platform for just €10 per month
            </p>
      ...
      <footer className="site-footer">
        <div className="page-container site-footer__grid">
          <div className="site-footer__column">
            <h3>Contact</h3>
            <p>
              <strong>Email:</strong> contact@aira.com
            </p>
            <p>
              <strong>Phone:</strong> +34111111111
            </p>
          </div>
